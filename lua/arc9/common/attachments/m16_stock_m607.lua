...
ATT.PrintName_TrueName = "M607 Collapsible Stock"
ATT.CompactName_TrueName = "M607"
ATT.Description_TrueName = [[An early attempt at a collapsible stock for an M16 based carbine. Improves handling somewhat without a major impact to aimed accuracy, though with some impact to recoil.]]
