...
ATT.PrintName_TrueName = "M231 FPW 14\" Barrel"
ATT.CompactName_TrueName = "14\"FPW"
ATT.Description_TrueName = [[Barrel designed for use from within the Bradley IFV. Does not come with a front sight.
